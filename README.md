...
You can use this app (formerly known as add-on) to install an _**in-memory**_ MariaDB, which is an
...
[Documentation]: https://github.com/lmagyar/homeassistant-addon-mariadb-inmemory/blob/master/mariadb/DOCS.md
